...
<head>
	...
	<link rel="stylesheet" href="./assets/richtexteditor/runtime/richtexteditor_preview.css" />
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="./" class="logo">
					<img src="assets/img/logo.png" alt="navbar brand" class="navbar-brand" style = "height: 27px; overflow: hidden; ">
				</a>
