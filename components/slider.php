                    ...
                    <div class="row clearfix">
                        <div class="col-lg-8 col-md-12 col-sm-12 offset-lg-2 text-center content-column">
                            <div class="inner-column"> 
                                <h1> We Are Haris <span class="color-yellow">Benzz <span></h1> 
                                <div class="btns-box">
                                    <a href="contact" class="theme-btn btn-style-one"><span class="txt"> Talk to us <i class="arrow flaticon-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div> 
